...
$replacements = @(
    ...
    @(' [PlaywrightTest("page-event-console.spec.ts", "clearConsoleMessages should work")]', ' //[PlaywrightTest("page-event-console.spec.ts", "clearConsoleMessages should work")]'),
    @(' [PlaywrightTest("page-event-console.spec.ts", "should have timestamp")]', ' //[PlaywrightTest("page-event-console.spec.ts", "should have timestamp")]'),
    @(' [PlaywrightTest("page-event-console.spec.ts", "consoleMessages sinceNavigation filter should work")]', ' //[PlaywrightTest("page-event-console.spec.ts", "consoleMessages sinceNavigation filter should work")]'),
    ...
    @(' [PlaywrightTest("browsercontext-events.spec.ts", "weberror event should include location")]', ' //[PlaywrightTest("browsercontext-events.spec.ts", "weberror event should include location")]'),
    ...
    @(' [PlaywrightTest("page-route-web-socket.spec.ts", "should expose protocols to the route handler")]', '//[PlaywrightTest("page-route-web-socket.spec.ts", "should expose protocols to the route handler")]'),
